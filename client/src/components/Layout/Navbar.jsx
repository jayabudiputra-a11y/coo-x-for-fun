                    ...
                    {_fL ? (
                      ...
                      <>
                        <div onClick={_hQuickPlay} style={{ cursor: 'pointer' }}>
                          <div style={{ width: '100px', height: '100px', margin: '0 auto 8px', border: '2px solid #000', position: 'relative', backgroundColor: '#eee' }}>
                            <img
          ...
          <div style={{ borderLeft: '1px solid #eee', paddingLeft: '10px' }}>
            {_u ? (
              <img
                ...
                width="28"
                height="28"
                style={{ width: '28px', height: '28px', borderRadius: '50%', border: '1px solid #d35400', cursor: 'pointer' }}
                onClick={_hLo}
              />
            ) : (
