...
const TermsOfService = () => {
  return (
    <div style={{ padding: '50px 20px', maxWidth: '800px', margin: '0 auto', fontFamily: 'sans-serif', lineHeight: '1.6', color: '#333' }}>
      <h1 style={{ color: '#d35400' }}>Ketentuan Layanan (Terms of Service)</h1>
      ...
      <p>Saya menggunakan layanan Google OAuth untuk memudahkan Anda masuk (login). Dengan masuk menggunakan akun Google, Anda bertanggung jawab untuk menjaga keamanan identitas akses Anda. Kami hanya mengakses informasi profil dasar (nama, email, foto profil) untuk identitas di kolom komentar.</p>

      <h2 style={{ fontSize: '1.2rem' }}>3. Konten Pengguna</h2>
      <p>Saat Anda menulis komentar atau memberikan reaksi pada resep, Anda dilarang mengirimkan konten yang bersifat SARA, kasar, atau melanggar hukum. Kami berhak menghapus konten yang dianggap tidak pantas.</p>

      <h2 style={{ fontSize: '1.2rem' }}>4. Hak Kekayaan Intelektual</h2>
      <p>Seluruh konten berupa teks, desain, dan struktur di situs ini adalah milik Coo-X-For.Fun, kecuali gambar yang berasal dari penyedia pihak ketiga (Pexels, Unsplash) yang hak ciptanya tetap pada pemilik aslinya.</p>

      <h2 style={{ fontSize: '1.2rem' }}>5. Batasan Tanggung Jawab</h2>
      <p>Coo-X-For.Fun tidak bertanggung jawab atas hasil masakan Anda. Resep disediakan "apa adanya" sebagai panduan edukasi dan hiburan.</p>
